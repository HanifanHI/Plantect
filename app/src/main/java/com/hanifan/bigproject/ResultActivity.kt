package com.hanifan.bigproject
...
import com.hanifan.bigproject.network.ApiConfig
import com.hanifan.bigproject.network.responsemodel.Default
import com.bumptech.glide.Glide
import kotlinx.android.synthetic.main.activity_result.*
import kotlinx.android.synthetic.main.activity_result.namaTanaman
import kotlinx.android.synthetic.main.activity_result.jenisTanaman
import kotlinx.android.synthetic.main.activity_result.deskripsi
import kotlinx.android.synthetic.main.activity_result.nutrisi
import kotlinx.android.synthetic.main.activity_result.manfaat
    ...
    private fun Result(){
        ...
        call.enqueue(object : retrofit2.Callback<Default>{
            ...
            override fun onResponse(call: Call<Default>?, response: Response<Default>?) {
                ...
                namaTanaman.setText(response?.body()?.nm_tmn)
                jenisTanaman.setText(response?.body()?.jns_tmn)
                deskripsi.setText(response?.body()?.deskripsi)
                nutrisi.setText(response?.body()?.nutrisi)
                manfaat.setText(response?.body()?.manfaat)
                if (response?.body()?.nm_tmn.isNullOrBlank()){
                    namaTanaman.setText("Jenis Tanaman\nBelum tersedia")
                    jenisTanaman.setText("null")
                    deskripsi.setText("null")
                    nutrisi.setText("null")
                    manfaat.setText("null")
                }
            }
